-- Script pour créer les tables markets et shipping directement dans Supabase
...
DROP POLICY IF EXISTS "Users can delete their own market settings" ON public.market_settings;
